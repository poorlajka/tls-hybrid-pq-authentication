 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.function"
...
#line 20 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.function"
...
#line 33 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.function"
static void test_pkcs7_asn1_fail(data_t *pkcs7_buf)
{
    int res;
...
static void test_pkcs7_asn1_fail_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_pkcs7_asn1_fail( &data0 );
}
#if defined(MBEDTLS_FS_IO)
#line 43 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.function"
static void test_pkcs7_parse(char *pkcs7_file, int res_expect)
{
...
static void test_pkcs7_parse_wrapper( void ** params )
{

    test_pkcs7_parse( (char *) params[0], ((mbedtls_test_argument_t *) params[1])->sint );
}
#endif /* MBEDTLS_FS_IO */
#if defined(MBEDTLS_FS_IO)
...
#line 61 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_pkcs7.function"
static void test_pkcs7_verify(char *pkcs7_file,
                  char *crt_files,
                  char *filetobesigned,
                  int do_hash_alg,
                  int res_expect)
...
static void test_pkcs7_verify_wrapper( void ** params )
{

    test_pkcs7_verify( (char *) params[0], (char *) params[1], (char *) params[2], ((mbedtls_test_argument_t *) params[3])->sint, ((mbedtls_test_argument_t *) params[4])->sint );
}
#endif /* MBEDTLS_RSA_C */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 0:
            {
                *out_value = MBEDTLS_PKCS7_SIGNED_DATA;
            }
            break;
        case 1:
            {
                *out_value = MBEDTLS_ERR_PKCS7_FEATURE_UNAVAILABLE;
            }
            break;
        case 2:
            {
                *out_value = MBEDTLS_ERR_PKCS7_INVALID_CERT;
            }
            break;
        case 3:
            {
                *out_value = MBEDTLS_ERR_PKCS7_INVALID_ALG;
            }
            break;
        case 4:
            {
                *out_value = MBEDTLS_ERROR_ADD(MBEDTLS_ERR_PKCS7_INVALID_SIGNER_INFO,MBEDTLS_ERR_ASN1_UNEXPECTED_TAG);
            }
            break;
        case 5:
            {
                *out_value = MBEDTLS_ERR_PKCS7_INVALID_SIGNER_INFO;
            }
            break;
        case 6:
            {
                *out_value = MBEDTLS_ERR_PKCS7_INVALID_VERSION;
            }
            break;
        case 7:
            {
        ...
        case 11:
            {
                *out_value = MBEDTLS_ERR_PKCS7_VERIFY_FAIL;
            }
            break;
        case 12:
            {
                *out_value = MBEDTLS_ERR_PKCS7_CERT_DATE_INVALID;
            }
            break;
#endif
...
#if defined(MBEDTLS_PKCS7_C)
    test_pkcs7_asn1_fail_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */

#if defined(MBEDTLS_PKCS7_C) && defined(MBEDTLS_FS_IO)
    test_pkcs7_parse_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */

#if defined(MBEDTLS_PKCS7_C) && defined(MBEDTLS_FS_IO) && defined(MBEDTLS_X509_CRT_PARSE_C) && defined(MBEDTLS_PKCS1_V15) && defined(MBEDTLS_RSA_C)
    test_pkcs7_verify_wrapper,
#else
    NULL,
#endif
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_pkcs7.datax";
