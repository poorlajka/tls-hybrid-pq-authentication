 ...
 *
 * Test file      : ./test_suite_ssl_decrypt.misc.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_ssl_decrypt.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_ssl_decrypt.misc.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_ssl_decrypt.function"
...
#line 17 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_ssl_decrypt.function"
static void test_ssl_decrypt_null(int hash_id)
{
...
static void test_ssl_decrypt_null_wrapper( void ** params )
{

    test_ssl_decrypt_null( ((mbedtls_test_argument_t *) params[0])->sint );
}
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
#line 124 "/home/viktor/tls-hybrid-authentication/mbedtls/tests/suites/test_suite_ssl_decrypt.function"
...
static void test_ssl_decrypt_non_etm_cbc_wrapper( void ** params )
{
    ...
    test_ssl_decrypt_non_etm_cbc( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, ((mbedtls_test_argument_t *) params[3])->sint );
}
#endif /* MBEDTLS_SSL_PROTO_TLS1_2 */
...
#if defined(MBEDTLS_SSL_TLS_C) && defined(MBEDTLS_SSL_PROTO_TLS1_2) && defined(MBEDTLS_CIPHER_NULL_CIPHER)
    test_ssl_decrypt_null_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */

#if defined(MBEDTLS_SSL_TLS_C) && defined(PSA_WANT_ALG_CBC_NO_PADDING) && defined(PSA_WANT_KEY_TYPE_AES) && defined(MBEDTLS_SSL_PROTO_TLS1_2)
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_ssl_decrypt.misc.datax";
