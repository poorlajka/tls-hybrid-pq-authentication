 ...
 *
 * Test file      : ./test_suite_block_cipher.psa.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_block_cipher.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_block_cipher.psa.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_block_cipher.function"
...
#endif
#if defined(VALID_CIPHER_ID)
#line 26 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_block_cipher.function"
...
static void test_invalid_wrapper( void ** params )
{
    (void)params;

    test_invalid(  );
}
#endif /* VALID_CIPHER_ID */
#line 67 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_block_cipher.function"
static void test_test_vec(int cipher_id_arg, data_t *key, data_t *input, data_t *outref)
{
    mbedtls_block_cipher_context_t ctx;
...
static void test_test_vec_wrapper( void ** params )
{
    ...
    test_test_vec( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, &data5 );
}
#line 97 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_block_cipher.function"
static void test_block_cipher_psa_dynamic_dispatch(int cipher_type, int pre_psa_ret, int post_psa_engine)
{
    mbedtls_block_cipher_context_t ctx;
...
static void test_block_cipher_psa_dynamic_dispatch_wrapper( void ** params )
{

    test_block_cipher_psa_dynamic_dispatch( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 1:
            {
                *out_value = MBEDTLS_BLOCK_CIPHER_ENGINE_LEGACY;
            }
            break;
        case 2:
            {
        ...
        case 3:
            {
                *out_value = MBEDTLS_BLOCK_CIPHER_ENGINE_PSA;
            }
            break;
        case 4:
            {
                *out_value = MBEDTLS_CIPHER_ID_ARIA;
            }
            break;
        case 5:
            {
...
#if defined(MBEDTLS_BLOCK_CIPHER_C) && defined(VALID_CIPHER_ID)
    test_invalid_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_BLOCK_CIPHER_C)
    test_block_cipher_psa_dynamic_dispatch_wrapper,
#else
    NULL,
#endif
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_block_cipher.psa.datax";
