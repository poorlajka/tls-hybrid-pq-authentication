 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.function"
#include "mbedtls/chachapoly.h"
#line 11 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.function"
static void test_mbedtls_chachapoly_enc(data_t *key_str,
                            data_t *nonce_str,
                            data_t *aad_str,
                            data_t *input_str,
                            data_t *output_str,
...
static void test_mbedtls_chachapoly_enc_wrapper( void ** params )
{
...
#line 44 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.function"
static void test_mbedtls_chachapoly_dec(data_t *key_str,
                            data_t *nonce_str,
                            data_t *aad_str,
                            data_t *input_str,
                            data_t *output_str,
...
static void test_mbedtls_chachapoly_dec_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data4 = {(uint8_t *) params[4], ((mbedtls_test_argument_t *) params[5])->len};
    ...
    test_mbedtls_chachapoly_dec( &data0, &data2, &data4, &data6, &data8, &data10, ((mbedtls_test_argument_t *) params[12])->sint );
}
#line 80 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.function"
static void test_chachapoly_state(void)
{
...
static void test_chachapoly_state_wrapper( void ** params )
{
    (void)params;
...
#line 160 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_chachapoly.function"
static void test_chachapoly_selftest(void)
{
...
static void test_chachapoly_selftest_wrapper( void ** params )
{
    (void)params;
