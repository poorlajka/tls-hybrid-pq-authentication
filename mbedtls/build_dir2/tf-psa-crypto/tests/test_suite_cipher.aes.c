 ...
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cipher.aes.data
 *
 */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 13:
            {
                *out_value = MBEDTLS_CIPHER_AES_128_CCM_STAR_NO_TAG;
            }
            break;
        case 14:
            {
                *out_value = MBEDTLS_CIPHER_AES_192_CCM_STAR_NO_TAG;
            }
            break;
        case 15:
            {
                *out_value = MBEDTLS_CIPHER_AES_256_CCM_STAR_NO_TAG;
            }
            break;
        case 16:
            {
