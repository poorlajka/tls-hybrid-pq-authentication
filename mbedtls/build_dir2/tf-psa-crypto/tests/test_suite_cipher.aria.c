 ...
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cipher.aria.data
 *
 */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 1:
            {
                *out_value = MBEDTLS_CIPHER_ARIA_128_CCM_STAR_NO_TAG;
            }
            break;
        case 2:
            {
                *out_value = MBEDTLS_CIPHER_ARIA_192_CCM_STAR_NO_TAG;
            }
            break;
        case 3:
            {
                *out_value = MBEDTLS_CIPHER_ARIA_256_CCM_STAR_NO_TAG;
            }
            break;
        case 4:
            {
