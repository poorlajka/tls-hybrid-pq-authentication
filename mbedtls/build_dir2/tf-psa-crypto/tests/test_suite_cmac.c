 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function"
#include "mbedtls/cipher.h"
#include "mbedtls/cmac.h"
#if defined(MBEDTLS_SELF_TEST)
#line 12 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function"
static void test_mbedtls_cmac_self_test(void)
{
...
static void test_mbedtls_cmac_self_test_wrapper( void ** params )
{
    (void)params;
...
#line 19 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function"
static void test_mbedtls_cmac_null_args(void)
{
...
static void test_mbedtls_cmac_null_args_wrapper( void ** params )
{
    (void)params;

    test_mbedtls_cmac_null_args(  );
}
#line 102 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function"
static void test_mbedtls_cmac_setkey(int cipher_type, int key_size, int result)
{
    const mbedtls_cipher_info_t *cipher_info;
...
static void test_mbedtls_cmac_setkey_wrapper( void ** params )
{

    test_mbedtls_cmac_setkey( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
#line 128 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function"
static void test_mbedtls_cmac_multiple_blocks(int cipher_type, data_t *key,
...
static void test_mbedtls_cmac_multiple_blocks_wrapper( void ** params )
{
    ...
    test_mbedtls_cmac_multiple_blocks( ((mbedtls_test_argument_t *) params[0])->sint, &data1, ((mbedtls_test_argument_t *) params[3])->sint, ((mbedtls_test_argument_t *) params[4])->sint, &data5, ((mbedtls_test_argument_t *) params[7])->sint, &data8, ((mbedtls_test_argument_t *) params[10])->sint, &data11, ((mbedtls_test_argument_t *) params[13])->sint, &data14, ((mbedtls_test_argument_t *) params[16])->sint, &data17 );
}
#line 196 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_cmac.function"
static void test_mbedtls_cmac_multiple_operations_same_key(int cipher_type,
...
static void test_mbedtls_cmac_multiple_operations_same_key_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
    data_t data8 = {(uint8_t *) params[8], ((mbedtls_test_argument_t *) params[9])->len};
    data_t data11 = {(uint8_t *) params[11], ((mbedtls_test_argument_t *) params[12])->len};
    data_t data14 = {(uint8_t *) params[14], ((mbedtls_test_argument_t *) params[15])->len};
    data_t data16 = {(uint8_t *) params[16], ((mbedtls_test_argument_t *) params[17])->len};
    data_t data19 = {(uint8_t *) params[19], ((mbedtls_test_argument_t *) params[20])->len};
    data_t data22 = {(uint8_t *) params[22], ((mbedtls_test_argument_t *) params[23])->len};
    data_t data25 = {(uint8_t *) params[25], ((mbedtls_test_argument_t *) params[26])->len};

    test_mbedtls_cmac_multiple_operations_same_key( ((mbedtls_test_argument_t *) params[0])->sint, &data1, ((mbedtls_test_argument_t *) params[3])->sint, ((mbedtls_test_argument_t *) params[4])->sint, &data5, ((mbedtls_test_argument_t *) params[7])->sint, &data8, ((mbedtls_test_argument_t *) params[10])->sint, &data11, ((mbedtls_test_argument_t *) params[13])->sint, &data14, &data16, ((mbedtls_test_argument_t *) params[18])->sint, &data19, ((mbedtls_test_argument_t *) params[21])->sint, &data22, ((mbedtls_test_argument_t *) params[24])->sint, &data25 );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 5:
            {
                *out_value = MBEDTLS_CIPHER_CAMELLIA_128_ECB;
            }
            break;
        case 6:
            {
                *out_value = MBEDTLS_CIPHER_CAMELLIA_192_ECB;
            }
            break;
        case 7:
            {
                *out_value = MBEDTLS_CIPHER_CAMELLIA_256_ECB;
            }
            break;
        case 8:
            {
                *out_value = MBEDTLS_CIPHER_ARIA_128_ECB;
            }
            break;
        case 9:
            {
                *out_value = MBEDTLS_CIPHER_ARIA_192_ECB;
            }
            break;
        case 10:
            {
                *out_value = MBEDTLS_CIPHER_ARIA_256_ECB;
            }
            break;
#endif
