 ...
 *
 * Test file      : ./test_suite_constant_time.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
...
#line 25 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memcmp_null(void)
{
    uint32_t x = 0;
...
static void test_mbedtls_ct_memcmp_null_wrapper( void ** params )
{
    (void)params;

    test_mbedtls_ct_memcmp_null(  );
}
#line 35 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_bool(char *input)
{
...
static void test_mbedtls_ct_bool_wrapper( void ** params )
{

    test_mbedtls_ct_bool( (char *) params[0] );
}
#line 48 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_bool_xxx(char *x_str, char *y_str)
{
...
static void test_mbedtls_ct_bool_xxx_wrapper( void ** params )
{

    test_mbedtls_ct_bool_xxx( (char *) params[0], (char *) params[1] );
}
#if defined(MBEDTLS_BASE64_C)
#line 95 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_uchar_in_range_if(int li, int hi, int ti)
{
...
static void test_mbedtls_ct_uchar_in_range_if_wrapper( void ** params )
{

    test_mbedtls_ct_uchar_in_range_if( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
#endif /* MBEDTLS_BASE64_C */
#line 118 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_error_if(int cond, int t, int f)
{
...
static void test_mbedtls_ct_error_if_wrapper( void ** params )
{

    test_mbedtls_ct_error_if( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
#line 139 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_if(char *c_str, char *t_str, char *f_str)
{
...
static void test_mbedtls_ct_if_wrapper( void ** params )
{

    test_mbedtls_ct_if( (char *) params[0], (char *) params[1], (char *) params[2] );
}
#if defined(MBEDTLS_PKCS1_V15)
#if defined(MBEDTLS_RSA_C)
#line 175 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_zeroize_if(char *c_str, int len)
{
    uint8_t *buf = NULL;
    mbedtls_ct_condition_t c = mbedtls_ct_bool(strtoull(c_str, NULL, 16));
...
static void test_mbedtls_ct_zeroize_if_wrapper( void ** params )
{

    test_mbedtls_ct_zeroize_if( (char *) params[0], ((mbedtls_test_argument_t *) params[1])->sint );
}
#endif /* MBEDTLS_RSA_C */
#endif /* MBEDTLS_PKCS1_V15 */
#line 200 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memcmp_single_bit_diff(void)
{
...
static void test_mbedtls_ct_memcmp_single_bit_diff_wrapper( void ** params )
{
    (void)params;

    test_mbedtls_ct_memcmp_single_bit_diff(  );
}
#line 243 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memcmp(int same, int size, int offset)
{
    uint8_t *a = NULL, *b = NULL;
...
static void test_mbedtls_ct_memcmp_wrapper( void ** params )
{

    test_mbedtls_ct_memcmp( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
#if defined(MBEDTLS_NIST_KW_C)
#line 287 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
...
static void test_mbedtls_ct_memcmp_partial(int diff, int size, int skip_head, int skip_tail)
{
    uint8_t *a = NULL, *b = NULL;
...
static void test_mbedtls_ct_memcmp_partial_wrapper( void ** params )
{

    test_mbedtls_ct_memcmp_partial( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, ((mbedtls_test_argument_t *) params[3])->sint );
}
#endif /* MBEDTLS_NIST_KW_C */
#line 336 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memcpy_if(int eq, int size, int offset)
{
...
static void test_mbedtls_ct_memcpy_if_wrapper( void ** params )
{

    test_mbedtls_ct_memcpy_if( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
#if defined(MBEDTLS_PKCS1_V15)
#if defined(MBEDTLS_RSA_C)
#line 435 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memmove_left(int len, int offset)
{
    size_t l = (size_t) len;
...
static void test_mbedtls_ct_memmove_left_wrapper( void ** params )
{

    test_mbedtls_ct_memmove_left( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
#endif /* MBEDTLS_RSA_C */
#endif /* MBEDTLS_PKCS1_V15 */
#line 467 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_constant_time.function"
static void test_mbedtls_ct_memcpy_offset(int offset_min, int offset_max, int len)
{
...
static void test_mbedtls_ct_memcpy_offset_wrapper( void ** params )
{

    test_mbedtls_ct_memcpy_offset( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint );
}
...
TestWrapper_t test_funcs[] =
{
    ...
    test_mbedtls_ct_memcmp_null_wrapper,
/* Function Id: 1 */

    test_mbedtls_ct_bool_wrapper,
/* Function Id: 2 */

    test_mbedtls_ct_bool_xxx_wrapper,
/* Function Id: 3 */

#if defined(MBEDTLS_BASE64_C)
    test_mbedtls_ct_uchar_in_range_if_wrapper,
#else
    NULL,
#endif
/* Function Id: 4 */

    test_mbedtls_ct_error_if_wrapper,
/* Function Id: 5 */

    test_mbedtls_ct_if_wrapper,
/* Function Id: 6 */

#if defined(MBEDTLS_PKCS1_V15) && defined(MBEDTLS_RSA_C)
    test_mbedtls_ct_zeroize_if_wrapper,
#else
    NULL,
#endif
/* Function Id: 7 */

    test_mbedtls_ct_memcmp_single_bit_diff_wrapper,
/* Function Id: 8 */

    test_mbedtls_ct_memcmp_wrapper,
/* Function Id: 9 */

#if defined(MBEDTLS_NIST_KW_C)
    test_mbedtls_ct_memcmp_partial_wrapper,
#else
    NULL,
#endif
/* Function Id: 10 */

    test_mbedtls_ct_memcpy_if_wrapper,
/* Function Id: 11 */

#if defined(MBEDTLS_PKCS1_V15) && defined(MBEDTLS_RSA_C)
    test_mbedtls_ct_memmove_left_wrapper,
#else
    NULL,
#endif
/* Function Id: 12 */

    test_mbedtls_ct_memcpy_offset_wrapper,
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_constant_time.datax";
