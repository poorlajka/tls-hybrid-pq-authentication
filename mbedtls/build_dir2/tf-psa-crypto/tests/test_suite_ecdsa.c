 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
#include "mbedtls/ecdsa.h"
#line 11 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
static void test_ecdsa_prim_zero(int id)
{
...
static void test_ecdsa_prim_zero_wrapper( void ** params )
{

    test_ecdsa_prim_zero( ((mbedtls_test_argument_t *) params[0])->sint );
}
#line 43 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
...
static void test_ecdsa_prim_random_wrapper( void ** params )
{
    ...
    test_ecdsa_prim_random( ((mbedtls_test_argument_t *) params[0])->sint );
}
#line 78 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
...
static void test_ecdsa_prim_test_vectors_wrapper( void ** params )
{
    ...
    test_ecdsa_prim_test_vectors( ((mbedtls_test_argument_t *) params[0])->sint, (char *) params[1], (char *) params[2], (char *) params[3], &data4, &data6, (char *) params[8], (char *) params[9], ((mbedtls_test_argument_t *) params[10])->sint );
}
#if defined(MBEDTLS_ECDSA_DETERMINISTIC)
#line 194 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
static void test_ecdsa_det_test_vectors(int id, char *d_str, int md_alg, data_t *hash,
...
static void test_ecdsa_det_test_vectors_wrapper( void ** params )
{
    ...
    test_ecdsa_det_test_vectors( ((mbedtls_test_argument_t *) params[0])->sint, (char *) params[1], ((mbedtls_test_argument_t *) params[2])->sint, &data3, (char *) params[5], (char *) params[6] );
}
#endif /* MBEDTLS_ECDSA_DETERMINISTIC */
#if defined(PSA_WANT_ALG_SHA_256)
#line 229 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
static void test_ecdsa_write_read_zero(int id)
{
...
static void test_ecdsa_write_read_zero_wrapper( void ** params )
{

    test_ecdsa_write_read_zero( ((mbedtls_test_argument_t *) params[0])->sint );
}
#endif /* PSA_WANT_ALG_SHA_256 */
#if defined(PSA_WANT_ALG_SHA_256)
#line 294 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
...
static void test_ecdsa_write_read_random_wrapper( void ** params )
{
    ...
    test_ecdsa_write_read_random( ((mbedtls_test_argument_t *) params[0])->sint );
}
#endif /* PSA_WANT_ALG_SHA_256 */
#if defined(MBEDTLS_ECP_RESTARTABLE)
#line 363 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
static void test_ecdsa_read_restart(int id, data_t *pk, data_t *hash, data_t *sig,
...
static void test_ecdsa_read_restart_wrapper( void ** params )
{
    ...
    test_ecdsa_read_restart( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, &data5, ((mbedtls_test_argument_t *) params[7])->sint, ((mbedtls_test_argument_t *) params[8])->sint, ((mbedtls_test_argument_t *) params[9])->sint );
}
#endif /* MBEDTLS_ECP_RESTARTABLE */
#if defined(MBEDTLS_ECP_RESTARTABLE)
#if defined(MBEDTLS_ECDSA_DETERMINISTIC)
#line 428 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
static void test_ecdsa_write_restart(int id, char *d_str, int md_alg,
...
static void test_ecdsa_write_restart_wrapper( void ** params )
{
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};

    test_ecdsa_write_restart( ((mbedtls_test_argument_t *) params[0])->sint, (char *) params[1], ((mbedtls_test_argument_t *) params[2])->sint, &data3, &data5, ((mbedtls_test_argument_t *) params[7])->sint, ((mbedtls_test_argument_t *) params[8])->sint, ((mbedtls_test_argument_t *) params[9])->sint );
}
#endif /* MBEDTLS_ECDSA_DETERMINISTIC */
#endif /* MBEDTLS_ECP_RESTARTABLE */
#line 495 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecdsa.function"
static void test_ecdsa_verify(int grp_id, char *x, char *y, char *r, char *s, data_t *content, int expected)
{
    mbedtls_ecdsa_context ctx;
...
static void test_ecdsa_verify_wrapper( void ** params )
{
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};

    test_ecdsa_verify( ((mbedtls_test_argument_t *) params[0])->sint, (char *) params[1], (char *) params[2], (char *) params[3], (char *) params[4], &data5, ((mbedtls_test_argument_t *) params[7])->sint );
}
...
#if defined(MBEDTLS_ECDSA_C) && defined(PSA_WANT_ALG_SHA_256)
