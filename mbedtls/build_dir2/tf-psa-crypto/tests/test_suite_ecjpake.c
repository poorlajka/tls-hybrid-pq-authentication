 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
...
#line 102 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
static void test_ecjpake_invalid_param(void)
{
...
static void test_ecjpake_invalid_param_wrapper( void ** params )
{
    (void)params;
...
#line 126 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
static void test_ecjpake_selftest(void)
{
    MD_PSA_INIT();
...
static void test_ecjpake_selftest_wrapper( void ** params )
{
    (void)params;
...
#line 138 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
static void test_read_bad_md(data_t *msg)
{
...
static void test_read_bad_md_wrapper( void ** params )
{
...
#if defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED)
#if defined(PSA_WANT_ALG_SHA_256)
#line 163 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
static void test_read_round_one(int role, data_t *msg, int ref_ret)
{
    mbedtls_ecjpake_context ctx;
    mbedtls_ecjpake_init(&ctx);
    const unsigned char *pw = NULL;
...
static void test_read_round_one_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};

    test_read_round_one( ((mbedtls_test_argument_t *) params[0])->sint, &data1, ((mbedtls_test_argument_t *) params[3])->sint );
}
#endif /* PSA_WANT_ALG_SHA_256 */
#endif /* MBEDTLS_ECP_DP_SECP256R1_ENABLED */
#if defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED)
#if defined(PSA_WANT_ALG_SHA_256)
#line 185 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
static void test_read_round_two_cli(data_t *msg, int ref_ret)
{
    mbedtls_ecjpake_context ctx;
    mbedtls_ecjpake_init(&ctx);
    const unsigned char *pw = NULL;
...
static void test_read_round_two_cli_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_read_round_two_cli( &data0, ((mbedtls_test_argument_t *) params[2])->sint );
}
#endif /* PSA_WANT_ALG_SHA_256 */
#endif /* MBEDTLS_ECP_DP_SECP256R1_ENABLED */
#if defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED)
#if defined(PSA_WANT_ALG_SHA_256)
#line 213 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_ecjpake.function"
static void test_read_round_two_srv(data_t *msg, int ref_ret)
{
    mbedtls_ecjpake_context ctx;
    mbedtls_ecjpake_init(&ctx);
    const unsigned char *pw = NULL;
...
static void test_read_round_two_srv_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_read_round_two_srv( &data0, ((mbedtls_test_argument_t *) params[2])->sint );
}
#endif /* PSA_WANT_ALG_SHA_256 */
#endif /* MBEDTLS_ECP_DP_SECP256R1_ENABLED */
...
#if defined(MBEDTLS_ECJPAKE_C) && defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED) && defined(PSA_WANT_ALG_SHA_256)
