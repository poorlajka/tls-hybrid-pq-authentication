 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function"
#include "mbedtls/hkdf.h"
#include "md_wrap.h"
#line 12 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function"
static void test_test_hkdf(int md_alg, data_t *ikm, data_t *salt, data_t *info,
               data_t *expected_okm)
{
    int ret;
...
static void test_test_hkdf_wrapper( void ** params )
{
...
#line 38 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function"
static void test_test_hkdf_extract(int md_alg,
                       data_t *ikm,
                       data_t *salt,
                       data_t *prk)
{
...
static void test_test_hkdf_extract_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
...
#line 68 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function"
static void test_test_hkdf_expand(int md_alg,
                      data_t *info,
                      data_t *prk,
                      data_t *okm)
{
...
static void test_test_hkdf_expand_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
...
#line 100 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function"
static void test_test_hkdf_extract_ret(int hash_len, int ret)
{
    int output_ret;
...
static void test_test_hkdf_extract_ret_wrapper( void ** params )
{

    test_test_hkdf_extract_ret( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
#line 127 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hkdf.function"
static void test_test_hkdf_expand_ret(int hash_len, int prk_len, int okm_len, int ret)
{
    int output_ret;
...
static void test_test_hkdf_expand_ret_wrapper( void ** params )
{
