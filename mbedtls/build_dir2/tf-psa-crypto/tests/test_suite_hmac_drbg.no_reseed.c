 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.no_reseed.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
...
#line 33 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_entropy_usage(int md_alg)
{
...
static void test_hmac_drbg_entropy_usage_wrapper( void ** params )
{

    test_hmac_drbg_entropy_usage( ((mbedtls_test_argument_t *) params[0])->sint );
}
#if defined(MBEDTLS_FS_IO)
#line 128 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_seed_file(int md_alg, char *path, int ret)
{
    const mbedtls_md_info_t *md_info;
    mbedtls_hmac_drbg_context ctx;
    mbedtls_hmac_drbg_init(&ctx);
...
static void test_hmac_drbg_seed_file_wrapper( void ** params )
{

    test_hmac_drbg_seed_file( ((mbedtls_test_argument_t *) params[0])->sint, (char *) params[1], ((mbedtls_test_argument_t *) params[2])->sint );
}
#endif /* MBEDTLS_FS_IO */
#line 153 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_buf(int md_alg)
{
    unsigned char out[16];
...
static void test_hmac_drbg_buf_wrapper( void ** params )
{

    test_hmac_drbg_buf( ((mbedtls_test_argument_t *) params[0])->sint );
}
#line 186 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_no_reseed(int md_alg, data_t *entropy,
...
static void test_hmac_drbg_no_reseed_wrapper( void ** params )
{
...
#line 237 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_nopr(int md_alg, data_t *entropy, data_t *custom,
...
static void test_hmac_drbg_nopr_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
...
#line 273 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_pr(int md_alg, data_t *entropy, data_t *custom,
...
static void test_hmac_drbg_pr_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
...
#line 308 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_hmac_drbg.function"
static void test_hmac_drbg_selftest(void)
{
    MD_PSA_INIT();
...
static void test_hmac_drbg_selftest_wrapper( void ** params )
{
    (void)params;
