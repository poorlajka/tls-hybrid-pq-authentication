 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
#include "lmots.h"
...
#line 31 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
static void test_lmots_sign_verify_test(data_t *msg, data_t *key_id, int leaf_id,
                            data_t *seed)
{
...
static void test_lmots_sign_verify_test_wrapper( void ** params )
{
    ...
    test_lmots_sign_verify_test( &data0, &data2, ((mbedtls_test_argument_t *) params[4])->sint, &data5 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
#if defined(MBEDTLS_LMS_PRIVATE)
#line 57 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
static void test_lmots_sign_verify_null_msg_test(data_t *key_id, int leaf_id, data_t *seed)
{
    mbedtls_lmots_public_t pub_ctx;
    mbedtls_lmots_private_t priv_ctx;
    unsigned char sig[MBEDTLS_LMOTS_SIG_LEN(MBEDTLS_LMOTS_SHA256_N32_W8)];
...
static void test_lmots_sign_verify_null_msg_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};

    test_lmots_sign_verify_null_msg_test( &data0, ((mbedtls_test_argument_t *) params[2])->sint, &data3 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
#line 82 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
static void test_lmots_verify_test(data_t *msg, data_t *sig, data_t *pub_key,
                       int expected_rc)
{
...
static void test_lmots_verify_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data4 = {(uint8_t *) params[4], ((mbedtls_test_argument_t *) params[5])->len};

    test_lmots_verify_test( &data0, &data2, &data4, ((mbedtls_test_argument_t *) params[6])->sint );
}
#line 150 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
static void test_lmots_import_export_test(data_t *pub_key, int expected_import_rc)
{
    mbedtls_lmots_public_t ctx;
...
static void test_lmots_import_export_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_lmots_import_export_test( &data0, ((mbedtls_test_argument_t *) params[2])->sint );
}
#if defined(MBEDTLS_LMS_PRIVATE)
#line 208 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
static void test_lmots_reuse_test(data_t *msg, data_t *key_id, int leaf_id, data_t *seed)
{
...
static void test_lmots_reuse_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};

    test_lmots_reuse_test( &data0, &data2, ((mbedtls_test_argument_t *) params[4])->sint, &data5 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
#if defined(MBEDTLS_TEST_HOOKS)
#if defined(MBEDTLS_LMS_PRIVATE)
#line 235 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_lmots.function"
static void test_lmots_signature_leak_test(data_t *msg, data_t *key_id, int leaf_id,
                               data_t *seed)
{
    mbedtls_lmots_private_t ctx;
    unsigned char sig[MBEDTLS_LMOTS_SIG_LEN(MBEDTLS_LMOTS_SHA256_N32_W8)];
...
static void test_lmots_signature_leak_test_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};

    test_lmots_signature_leak_test( &data0, &data2, ((mbedtls_test_argument_t *) params[4])->sint, &data5 );
}
#endif /* MBEDTLS_LMS_PRIVATE */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 0:
            {
                *out_value = MBEDTLS_ERR_LMS_VERIFY_FAILED;
            }
            break;
        case 1:
            {
                *out_value = MBEDTLS_ERR_LMS_BAD_INPUT_DATA;
            }
            break;
#endif
...
TestWrapper_t test_funcs[] =
{
    ...
    test_lmots_sign_verify_test_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_LMS_C) && defined(MBEDTLS_LMS_PRIVATE)
    test_lmots_sign_verify_null_msg_test_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
...
#if defined(MBEDTLS_LMS_C)
    test_lmots_verify_test_wrapper,
#else
    NULL,
#endif
/* Function Id: 3 */
...
#if defined(MBEDTLS_LMS_C)
    test_lmots_import_export_test_wrapper,
#else
    NULL,
#endif
/* Function Id: 4 */
...
#if defined(MBEDTLS_LMS_C) && defined(MBEDTLS_LMS_PRIVATE)
    test_lmots_reuse_test_wrapper,
#else
    NULL,
#endif
/* Function Id: 5 */

#if defined(MBEDTLS_LMS_C) && defined(MBEDTLS_TEST_HOOKS) && defined(MBEDTLS_LMS_PRIVATE)
    test_lmots_signature_leak_test_wrapper,
#else
    NULL,
#endif
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_lmots.datax";
