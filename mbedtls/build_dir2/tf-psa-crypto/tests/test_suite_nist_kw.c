 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
#include "mbedtls/nist_kw.h"
#if defined(MBEDTLS_SELF_TEST)
#if defined(MBEDTLS_AES_C)
#line 11 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_mbedtls_nist_kw_self_test(void)
{
...
static void test_mbedtls_nist_kw_self_test_wrapper( void ** params )
{
    (void)params;
...
#if defined(MBEDTLS_AES_C)
#line 18 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_mbedtls_nist_kw_mix_contexts(void)
{
...
static void test_mbedtls_nist_kw_mix_contexts_wrapper( void ** params )
{
    (void)params;
...
#endif /* MBEDTLS_AES_C */
#line 125 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_mbedtls_nist_kw_setkey(int cipher_id, int key_size,
...
static void test_mbedtls_nist_kw_setkey_wrapper( void ** params )
{

    test_mbedtls_nist_kw_setkey( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, ((mbedtls_test_argument_t *) params[3])->sint );
}
#if defined(MBEDTLS_AES_C)
#line 146 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_nist_kw_plaintext_lengths(int in_len, int out_len, int mode, int res)
{
    mbedtls_nist_kw_context ctx;
    unsigned char key[16];
...
static void test_nist_kw_plaintext_lengths_wrapper( void ** params )
{

    test_nist_kw_plaintext_lengths( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, ((mbedtls_test_argument_t *) params[3])->sint );
}
#endif /* MBEDTLS_AES_C */
#if defined(MBEDTLS_AES_C)
#line 193 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_nist_kw_ciphertext_lengths(int in_len, int out_len, int mode, int res)
{
    mbedtls_nist_kw_context ctx;
    unsigned char key[16];
    unsigned char *plaintext = NULL;
...
static void test_nist_kw_ciphertext_lengths_wrapper( void ** params )
{

    test_nist_kw_ciphertext_lengths( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, ((mbedtls_test_argument_t *) params[3])->sint );
}
#endif /* MBEDTLS_AES_C */
#line 237 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_mbedtls_nist_kw_wrap(int cipher_id, int mode, data_t *key, data_t *msg,
...
static void test_mbedtls_nist_kw_wrap_wrapper( void ** params )
{
    ...
    test_mbedtls_nist_kw_wrap( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, &data2, &data4, &data6 );
}
#line 271 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_nist_kw.function"
static void test_mbedtls_nist_kw_unwrap(int cipher_id, int mode, data_t *key, data_t *msg,
...
static void test_mbedtls_nist_kw_unwrap_wrapper( void ** params )
{
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    data_t data4 = {(uint8_t *) params[4], ((mbedtls_test_argument_t *) params[5])->len};
    data_t data6 = {(uint8_t *) params[6], ((mbedtls_test_argument_t *) params[7])->len};

    test_mbedtls_nist_kw_unwrap( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, &data2, &data4, &data6, ((mbedtls_test_argument_t *) params[8])->sint );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 4:
            {
                *out_value = MBEDTLS_CIPHER_ID_3DES;
            }
            break;
        case 5:
            {
