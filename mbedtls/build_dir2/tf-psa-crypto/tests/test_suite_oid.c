 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function"
#include "mbedtls/oid.h"
#include "mbedtls/asn1.h"
#include "mbedtls/asn1write.h"
#include "string.h"
#line 14 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function"
static void test_oid_get_certificate_policies(data_t *oid, char *result_str)
{
...
static void test_oid_get_certificate_policies_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_oid_get_certificate_policies( &data0, (char *) params[2] );
}
#line 35 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function"
static void test_oid_get_extended_key_usage(data_t *oid, char *result_str)
{
    mbedtls_asn1_buf asn1_buf = { 0, 0, NULL };
    int ret;
    const char *desc;
...
static void test_oid_get_extended_key_usage_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_oid_get_extended_key_usage( &data0, (char *) params[2] );
}
#line 56 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function"
static void test_oid_get_x509_extension(data_t *oid, int exp_type)
{
...
static void test_oid_get_x509_extension_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_oid_get_x509_extension( &data0, ((mbedtls_test_argument_t *) params[2])->sint );
}
#line 77 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function"
static void test_oid_get_md_alg_id(data_t *oid, int exp_md_id)
{
...
static void test_oid_get_md_alg_id_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_oid_get_md_alg_id( &data0, ((mbedtls_test_argument_t *) params[2])->sint );
}
#line 100 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_oid.function"
static void test_mbedtls_oid_get_md_hmac(data_t *oid, int exp_md_id)
{
    mbedtls_asn1_buf md_oid = { 0, 0, NULL };
    int ret;
    mbedtls_md_type_t md_id = 0;
...
static void test_mbedtls_oid_get_md_hmac_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};

    test_mbedtls_oid_get_md_hmac( &data0, ((mbedtls_test_argument_t *) params[2])->sint );
}
...
#if defined(MBEDTLS_OID_C) && !defined(MBEDTLS_X509_REMOVE_INFO)
...
#if defined(MBEDTLS_OID_C) && !defined(MBEDTLS_X509_REMOVE_INFO)
    test_mbedtls_oid_get_md_hmac_wrapper,
#else
    NULL,
#endif
