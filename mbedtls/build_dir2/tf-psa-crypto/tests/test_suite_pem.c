 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pem.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pem.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pem.function"
#include "mbedtls/base64.h"
#include "mbedtls/pem.h"
#include "mbedtls/des.h"
#include "mbedtls/aes.h"
#if defined(MBEDTLS_PEM_WRITE_C)
#line 9 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pem.function"
static void test_mbedtls_pem_write_buffer(char *start, char *end, data_t *buf,
                              char *result_str)
{
...
static void test_mbedtls_pem_write_buffer_wrapper( void ** params )
{
...
#if defined(MBEDTLS_PEM_WRITE_C)
#line 36 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pem.function"
static void test_mbedtls_pem_write_buffer_lengths(void)
{
...
static void test_mbedtls_pem_write_buffer_lengths_wrapper( void ** params )
{
    (void)params;

    test_mbedtls_pem_write_buffer_lengths(  );
}
#endif /* MBEDTLS_PEM_WRITE_C */
#if defined(MBEDTLS_PEM_PARSE_C)
#line 65 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pem.function"
static void test_mbedtls_pem_read_buffer(char *header, char *footer, char *data,
...
static void test_mbedtls_pem_read_buffer_wrapper( void ** params )
{
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};

    test_mbedtls_pem_read_buffer( (char *) params[0], (char *) params[1], (char *) params[2], (char *) params[3], ((mbedtls_test_argument_t *) params[4])->sint, &data5 );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 0:
            {
                *out_value = MBEDTLS_ERR_PEM_BAD_INPUT_DATA;
            }
            break;
        case 1:
            {
        ...
        case 5:
            {
                *out_value = MBEDTLS_ERR_PEM_PASSWORD_MISMATCH;
            }
            break;
...
#if defined(MBEDTLS_PEM_WRITE_C)
    test_mbedtls_pem_write_buffer_lengths_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
