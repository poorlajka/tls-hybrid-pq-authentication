 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs12.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs12.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs12.function"
...
#line 18 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs12.function"
static void test_pkcs12_derive_key(int md_type, int key_size_arg,
...
static void test_pkcs12_derive_key_wrapper( void ** params )
{
    ...
    test_pkcs12_derive_key( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, &data2, ((mbedtls_test_argument_t *) params[4])->sint, &data5, ((mbedtls_test_argument_t *) params[7])->sint, ((mbedtls_test_argument_t *) params[8])->sint, &data9, ((mbedtls_test_argument_t *) params[11])->sint );
}
#if defined(MBEDTLS_ASN1_PARSE_C)
#if defined(MBEDTLS_CIPHER_C)
#line 73 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs12.function"
static void test_pkcs12_pbe_encrypt(int params_tag, int cipher, int md, data_t *params_hex, data_t *pw,
...
static void test_pkcs12_pbe_encrypt_wrapper( void ** params )
{
    ...
    test_pkcs12_pbe_encrypt( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, &data3, &data5, &data7, ((mbedtls_test_argument_t *) params[9])->sint, ((mbedtls_test_argument_t *) params[10])->sint, &data11 );
}
#endif /* MBEDTLS_CIPHER_C */
#endif /* MBEDTLS_ASN1_PARSE_C */
#if defined(MBEDTLS_ASN1_PARSE_C)
#if defined(MBEDTLS_CIPHER_C)
#line 128 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs12.function"
static void test_pkcs12_pbe_decrypt(int params_tag, int cipher, int md, data_t *params_hex, data_t *pw,
                        data_t *data, int outsize, int ref_ret, data_t *ref_out)
{
    int my_ret;
    mbedtls_asn1_buf pbe_params;
...
static void test_pkcs12_pbe_decrypt_wrapper( void ** params )
{
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
    data_t data7 = {(uint8_t *) params[7], ((mbedtls_test_argument_t *) params[8])->len};
    ...
    test_pkcs12_pbe_decrypt( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, &data3, &data5, &data7, ((mbedtls_test_argument_t *) params[9])->sint, ((mbedtls_test_argument_t *) params[10])->sint, &data11 );
}
#endif /* MBEDTLS_CIPHER_C */
#endif /* MBEDTLS_ASN1_PARSE_C */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 1:
            {
                *out_value = USE_GIVEN_INPUT;
            }
            break;
        case 2:
            {
                *out_value = USE_NULL_INPUT;
            }
            break;
        case 3:
            {
                *out_value = MBEDTLS_ERR_PKCS12_BAD_INPUT_DATA;
            }
            break;
        case 4:
            {
        ...
        case 9:
            {
                *out_value = MBEDTLS_ERR_PKCS12_PASSWORD_MISMATCH;
            }
            break;
#endif
...
#if defined(MBEDTLS_PKCS12_C)
    test_pkcs12_derive_key_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */

#if defined(MBEDTLS_PKCS12_C) && defined(MBEDTLS_ASN1_PARSE_C) && defined(MBEDTLS_CIPHER_C)
    test_pkcs12_pbe_encrypt_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
...
#if defined(MBEDTLS_PKCS12_C) && defined(MBEDTLS_ASN1_PARSE_C) && defined(MBEDTLS_CIPHER_C)
    test_pkcs12_pbe_decrypt_wrapper,
#else
    NULL,
#endif
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_pkcs12.datax";
