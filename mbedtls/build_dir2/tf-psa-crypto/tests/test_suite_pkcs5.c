 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.function"
#include "mbedtls/error_common.h"
#include "mbedtls/pkcs5.h"
#include "mbedtls/cipher.h"
#line 13 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.function"
static void test_pbkdf2_hmac(int hash, data_t *pw_str, data_t *salt_str,
...
static void test_pbkdf2_hmac_wrapper( void ** params )
{
    ...
    test_pbkdf2_hmac( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, ((mbedtls_test_argument_t *) params[5])->sint, ((mbedtls_test_argument_t *) params[6])->sint, &data7 );
}
#if defined(MBEDTLS_ASN1_PARSE_C)
#if defined(MBEDTLS_CIPHER_C)
#line 32 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.function"
static void test_pbes2_encrypt(int params_tag, data_t *params_hex, data_t *pw,
...
static void test_pbes2_encrypt_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    ...
    test_pbes2_encrypt( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, &data5, ((mbedtls_test_argument_t *) params[7])->sint, ((mbedtls_test_argument_t *) params[8])->sint, &data9 );
}
#endif /* MBEDTLS_CIPHER_C */
#endif /* MBEDTLS_ASN1_PARSE_C */
#if defined(MBEDTLS_ASN1_PARSE_C)
#if defined(MBEDTLS_CIPHER_C)
#line 80 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.function"
static void test_pbes2_decrypt(int params_tag, data_t *params_hex, data_t *pw,
                   data_t *data, int outsize, int ref_ret,
                   data_t *ref_out)
{
    int my_ret;
...
static void test_pbes2_decrypt_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    data_t data5 = {(uint8_t *) params[5], ((mbedtls_test_argument_t *) params[6])->len};
    ...
    test_pbes2_decrypt( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, &data5, ((mbedtls_test_argument_t *) params[7])->sint, ((mbedtls_test_argument_t *) params[8])->sint, &data9 );
}
#endif /* MBEDTLS_CIPHER_C */
#endif /* MBEDTLS_ASN1_PARSE_C */
#if defined(MBEDTLS_SELF_TEST)
#line 129 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_pkcs5.function"
static void test_pkcs5_selftest(void)
{
    MD_PSA_INIT();
...
static void test_pkcs5_selftest_wrapper( void ** params )
{
    (void)params;
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 10:
            {
                *out_value = MBEDTLS_ERROR_ADD(MBEDTLS_ERR_PKCS5_INVALID_FORMAT, MBEDTLS_ERR_ASN1_UNEXPECTED_TAG);
            }
            break;
        case 11:
            {
                *out_value = MBEDTLS_ERROR_ADD(MBEDTLS_ERR_PKCS5_INVALID_FORMAT, MBEDTLS_ERR_ASN1_OUT_OF_DATA);
            }
            break;
        case 12:
            {
        ...
        case 13:
            {
                *out_value = MBEDTLS_ERROR_ADD(MBEDTLS_ERR_PKCS5_INVALID_FORMAT, MBEDTLS_ERR_ASN1_LENGTH_MISMATCH);
            }
            break;
        case 14:
            {
...
#if defined(MBEDTLS_PKCS5_C) && defined(MBEDTLS_ASN1_PARSE_C) && defined(MBEDTLS_CIPHER_C)
    test_pbes2_encrypt_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
