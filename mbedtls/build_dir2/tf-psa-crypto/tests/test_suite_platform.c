 ...
 *
 * Test file      : ./test_suite_platform.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function"
...
#if defined(MBEDTLS_HAVE_TIME)
#line 44 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function"
static void test_time_get_milliseconds(void)
{
...
static void test_time_get_milliseconds_wrapper( void ** params )
{
    (void)params;

    test_time_get_milliseconds(  );
}
#endif /* MBEDTLS_HAVE_TIME */
#if defined(MBEDTLS_HAVE_TIME)
#line 54 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function"
static void test_time_get_seconds(void)
{
...
static void test_time_get_seconds_wrapper( void ** params )
{
    (void)params;

    test_time_get_seconds(  );
}
#endif /* MBEDTLS_HAVE_TIME */
#if defined(MBEDTLS_HAVE_TIME)
#line 64 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function"
static void test_time_delay_milliseconds(int delay_ms)
{
    mbedtls_ms_time_t current = mbedtls_ms_time();
...
static void test_time_delay_milliseconds_wrapper( void ** params )
{

    test_time_delay_milliseconds( ((mbedtls_test_argument_t *) params[0])->sint );
}
#endif /* MBEDTLS_HAVE_TIME */
#if defined(MBEDTLS_HAVE_TIME)
#line 86 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function"
...
static void test_time_delay_seconds(int delay_secs)
{
    mbedtls_time_t current = mbedtls_time(NULL);
...
static void test_time_delay_seconds_wrapper( void ** params )
{

    test_time_delay_seconds( ((mbedtls_test_argument_t *) params[0])->sint );
}
#endif /* MBEDTLS_HAVE_TIME */
#line 125 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform.function"
static void test_check_mbedtls_calloc_overallocation(intmax_t num, intmax_t size)
{
    unsigned char *buf;
...
static void test_check_mbedtls_calloc_overallocation_wrapper( void ** params )
{

    test_check_mbedtls_calloc_overallocation( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
...
static int dep_check(int dep_id)
{
    ...
    switch (dep_id) {
        ...
        case 1:
            {
#if !defined(MBEDTLS_TEST_HAVE_MSAN)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 2:
            {
#if !defined(MBEDTLS_TEST_HAVE_TSAN)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
...
#if defined(MBEDTLS_HAVE_TIME)
    test_time_get_milliseconds_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_HAVE_TIME)
    test_time_delay_milliseconds_wrapper,
#else
    NULL,
#endif
/* Function Id: 3 */
...
#if defined(MBEDTLS_HAVE_TIME)
    test_time_delay_seconds_wrapper,
#else
    NULL,
#endif
/* Function Id: 4 */

    test_check_mbedtls_calloc_overallocation_wrapper,
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_platform.datax";
