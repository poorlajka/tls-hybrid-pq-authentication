 ...
 *
 * Test file      : ./test_suite_platform_printf.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_printf.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_printf.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_printf.function"
...
#line 28 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_printf.function"
static void test_printf_int(char *format,
                int x, char *result)
{
    char *output = NULL;
...
static void test_printf_int_wrapper( void ** params )
{

    test_printf_int( (char *) params[0], ((mbedtls_test_argument_t *) params[1])->sint, (char *) params[2] );
}
#line 47 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_printf.function"
static void test_printf_long_max(const char *format,
                     long value)
{
    char *expected = NULL;
    char *output = NULL;
...
static void test_printf_long_max_wrapper( void ** params )
{

    test_printf_long_max( (char *) params[0], ((mbedtls_test_argument_t *) params[1])->sint );
}
#line 73 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_printf.function"
static void test_printf_char2(char *format,
...
static void test_printf_char2_wrapper( void ** params )
{

    test_printf_char2( (char *) params[0], ((mbedtls_test_argument_t *) params[1])->sint, ((mbedtls_test_argument_t *) params[2])->sint, (char *) params[3] );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 3:
            {
                *out_value = SPACE_CHAR;
            }
            break;
        case 4:
            {
                *out_value = NEWLINE_CHAR;
            }
            break;
        case 5:
            {
                *out_value = DOUBLE_QUOTE_CHAR;
            }
            break;
        case 6:
            {
                *out_value = COLON_CHAR;
            }
            break;
        case 7:
            {
                *out_value = QUESTION_CHAR;
            }
            break;
        case 8:
            {
                *out_value = BACKSLASH_CHAR;
            }
            break;
        case 9:
            {
                *out_value = LOWERCASE_N_CHAR;
            }
            break;
...
TestWrapper_t test_funcs[] =
{
    ...
    test_printf_int_wrapper,
/* Function Id: 1 */

    test_printf_long_max_wrapper,
/* Function Id: 2 */

    test_printf_char2_wrapper,
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_platform_printf.datax";
