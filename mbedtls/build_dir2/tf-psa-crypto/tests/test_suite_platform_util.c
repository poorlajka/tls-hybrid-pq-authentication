 ...
 *
 * Test file      : ./test_suite_platform_util.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_util.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_util.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_util.function"
#include "mbedtls/platform_util.h"
#line 6 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_util.function"
static void test_mbedtls_platform_zeroize(int len, int null)
{
    char buf[130];
    char *p = NULL;
...
static void test_mbedtls_platform_zeroize_wrapper( void ** params )
{

    test_mbedtls_platform_zeroize( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
#line 44 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_platform_util.function"
static void test_mbedtls_platform_zeroize_uninitialised(int len, int p)
{
    /*
...
static void test_mbedtls_platform_zeroize_uninitialised_wrapper( void ** params )
{

    test_mbedtls_platform_zeroize_uninitialised( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
...
TestWrapper_t test_funcs[] =
{
    ...
    test_mbedtls_platform_zeroize_wrapper,
/* Function Id: 1 */

    test_mbedtls_platform_zeroize_uninitialised_wrapper,
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_platform_util.datax";
