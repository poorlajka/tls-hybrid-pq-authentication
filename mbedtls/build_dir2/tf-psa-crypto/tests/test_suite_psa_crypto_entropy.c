 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.function"
#include <stdint.h>
#include <string.h>
...
#line 72 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.function"
static void test_external_rng_failure_generate(void)
{
...
static void test_external_rng_failure_generate_wrapper( void ** params )
{
    (void)params;

    test_external_rng_failure_generate(  );
}
#endif /* MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 99 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.function"
static void test_external_rng_failure_sign(int key_type, data_t *key_data, int alg,
                               int input_size_arg)
{
...
static void test_external_rng_failure_sign_wrapper( void ** params )
{
...
#endif /* MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG */
#if defined(MBEDTLS_PSA_INJECT_ENTROPY)
#line 150 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.function"
static void test_validate_entropy_seed_injection(int seed_length_a,
...
static void test_validate_entropy_seed_injection_wrapper( void ** params )
{
...
#endif /* MBEDTLS_PSA_INJECT_ENTROPY */
#if defined(MBEDTLS_PSA_INJECT_ENTROPY)
#line 206 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_entropy.function"
static void test_run_entropy_inject_with_crypto_init(void)
{
    psa_status_t status;
    size_t i;
...
static void test_run_entropy_inject_with_crypto_init_wrapper( void ** params )
{
    (void)params;
...
#if defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_external_rng_failure_generate_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
    test_external_rng_failure_sign_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
