 ...
 *
 * Test file      : ./test_suite_psa_crypto_low_hash.generated.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_low_hash.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/build_dir2/tf-psa-crypto/tests/suites/test_suite_psa_crypto_low_hash.generated.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_low_hash.function"
/*
...
#line 26 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_low_hash.function"
static void test_hash_valid_one_shot(int alg_arg, data_t *input,
                         data_t *expected)
{
...
static void test_hash_valid_one_shot_wrapper( void ** params )
{
    ...
    test_hash_valid_one_shot( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3 );
}
#line 63 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_low_hash.function"
static void test_hash_valid_multipart(int alg_arg,
...
static void test_hash_valid_multipart_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};
    ...
    test_hash_valid_multipart( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, &data5, &data7 );
}
#line 167 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_low_hash.function"
static void test_hash_empty(int alg_arg, data_t *expected)
{
    psa_algorithm_t alg = alg_arg;
    uint8_t *output = NULL;
    size_t output_size = expected->len;
...
static void test_hash_empty_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_psa_crypto_low_hash.generated.datax";
