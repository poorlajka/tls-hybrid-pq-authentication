 ...
 *
 * Test file      : ./test_suite_psa_crypto_not_supported.misc.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_not_supported.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_not_supported.misc.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_not_supported.function"
...
#line 16 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_not_supported.function"
static void test_import_not_supported(int key_type, data_t *key_material)
{
...
static void test_import_not_supported_wrapper( void ** params )
{
...
#line 54 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_not_supported.function"
...
static void test_generate_not_supported_wrapper( void ** params )
{

    test_generate_not_supported( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 1:
            {
                *out_value = PSA_KEY_TYPE_CATEGORY_SYMMETRIC;
            }
            break;
#endif
...
#if defined(MBEDTLS_PSA_CRYPTO_C)
    test_import_not_supported_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C)
    test_generate_not_supported_wrapper,
#else
    NULL,
#endif
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_psa_crypto_not_supported.misc.datax";
