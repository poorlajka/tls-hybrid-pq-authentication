 ...
 *
 * Test file      : ./test_suite_psa_crypto_op_fail.misc.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.misc.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
...
#line 45 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
static void test_hash_fail(int alg_arg, int expected_status_arg)
{
...
static void test_hash_fail_wrapper( void ** params )
{

    test_hash_fail( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
#line 72 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
static void test_mac_fail(int key_type_arg, data_t *key_data,
...
static void test_mac_fail_wrapper( void ** params )
{
...
#line 118 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
static void test_cipher_fail(int key_type_arg, data_t *key_data,
                 int alg_arg, int expected_status_arg)
{
    psa_status_t expected_status = expected_status_arg;
    psa_key_type_t key_type = key_type_arg;
...
static void test_cipher_fail_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
...
#line 164 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
static void test_aead_fail(int key_type_arg, data_t *key_data,
               int alg_arg, int expected_status_arg)
{
    psa_status_t expected_status = expected_status_arg;
    psa_key_type_t key_type = key_type_arg;
...
static void test_aead_fail_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
...
#line 212 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
static void test_sign_fail(int key_type_arg, data_t *key_data,
...
static void test_sign_fail_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
...
#line 286 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
...
static void test_asymmetric_encryption_fail_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
...
#line 333 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
...
static void test_key_derivation_fail_wrapper( void ** params )
{

    test_key_derivation_fail( ((mbedtls_test_argument_t *) params[0])->sint, ((mbedtls_test_argument_t *) params[1])->sint );
}
#line 351 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_op_fail.function"
                        ...
                        int expected_status_arg)
{
    ...
    if (PSA_KEY_TYPE_IS_ECC(key_type)) {
        ...
        status = psa_key_agreement_iop_setup(&iop_operation, key_id, public_key,
                                             public_key_length, alg,
                                             &shared_secret_attributes);

        if (expected_status != PSA_SUCCESS) {
            TEST_STATUS(expected_status, status);
        } else {
...
static void test_key_agreement_fail_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_psa_crypto_op_fail.misc.datax";
