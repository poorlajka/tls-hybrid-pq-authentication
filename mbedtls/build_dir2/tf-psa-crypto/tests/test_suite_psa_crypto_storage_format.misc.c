 ...
 *
 * Test file      : ./test_suite_psa_crypto_storage_format.misc.c
 *
 ...
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_storage_format.misc.data
 *
 */
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 2:
            {
                *out_value = PSA_KEY_USAGE_EXPORT | PSA_KEY_USAGE_ENCRYPT;
            }
            break;
        case 3:
            {
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_psa_crypto_storage_format.misc.datax";
