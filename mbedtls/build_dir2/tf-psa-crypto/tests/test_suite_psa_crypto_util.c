 ...
 *
 * Test file      : ./test_suite_psa_crypto_util.c
 *
 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_util.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_util.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_util.function"
#include <test/helpers.h>
#include <mbedtls/psa_util.h>
#if defined(PSA_HAVE_ALG_SOME_ECDSA)
#line 7 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_util.function"
...
static void test_ecdsa_raw_to_der_wrapper( void ** params )
{
    ...
    test_ecdsa_raw_to_der( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, ((mbedtls_test_argument_t *) params[5])->sint );
}
#endif /* PSA_HAVE_ALG_SOME_ECDSA */
#if defined(PSA_HAVE_ALG_SOME_ECDSA)
#line 28 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_util.function"
...
static void test_ecdsa_raw_to_der_incremental_wrapper( void ** params )
{
    ...
    test_ecdsa_raw_to_der_incremental( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3 );
}
#endif /* PSA_HAVE_ALG_SOME_ECDSA */
#if defined(PSA_HAVE_ALG_SOME_ECDSA)
#line 58 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_psa_crypto_util.function"
...
static void test_ecdsa_der_to_raw_wrapper( void ** params )
{
    ...
    test_ecdsa_der_to_raw( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3, ((mbedtls_test_argument_t *) params[5])->sint );
}
#endif /* PSA_HAVE_ALG_SOME_ECDSA */
...
static int dep_check(int dep_id)
{
    ...
    switch (dep_id) {
        ...
        case 0:
            {
#if (PSA_VENDOR_ECC_MAX_CURVE_BITS>=256)
        ...
        case 1:
            {
#if (PSA_VENDOR_ECC_MAX_CURVE_BITS>=512)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
        ...
        case 2:
            {
#if (PSA_VENDOR_ECC_MAX_CURVE_BITS>=521)
                ret = DEPENDENCY_SUPPORTED;
#else
                ret = DEPENDENCY_NOT_SUPPORTED;
#endif
...
#if defined(PSA_HAVE_ALG_SOME_ECDSA)
    test_ecdsa_raw_to_der_incremental_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
