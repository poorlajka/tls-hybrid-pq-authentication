 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
...
#line 22 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_random_twice_with_ctr_drbg(void)
{
...
static void test_random_twice_with_ctr_drbg_wrapper( void ** params )
{
    (void)params;
...
#line 73 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_random_twice_with_hmac_drbg(int md_type)
{
    mbedtls_entropy_context entropy;
    mbedtls_entropy_init(&entropy);
...
static void test_random_twice_with_hmac_drbg_wrapper( void ** params )
{

    test_random_twice_with_hmac_drbg( ((mbedtls_test_argument_t *) params[0])->sint );
}
...
#line 116 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_random_twice_with_psa_from_classic(void)
{
    unsigned char output1[OUTPUT_SIZE];
    unsigned char output2[OUTPUT_SIZE];
...
static void test_random_twice_with_psa_from_classic_wrapper( void ** params )
{
    (void)params;
...
#if defined(MBEDTLS_PSA_CRYPTO_C)
#if !defined(MBEDTLS_PSA_CRYPTO_EXTERNAL_RNG)
#line 142 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_random_twice_with_psa_from_psa(void)
{
    unsigned char output1[OUTPUT_SIZE];
    unsigned char output2[OUTPUT_SIZE];
...
static void test_random_twice_with_psa_from_psa_wrapper( void ** params )
{
    (void)params;
...
#endif /* MBEDTLS_PSA_CRYPTO_C */
#if defined(MBEDTLS_PSA_CRYPTO_C)
#line 166 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_mbedtls_psa_get_random_no_init(void)
{
...
static void test_mbedtls_psa_get_random_no_init_wrapper( void ** params )
{
    (void)params;
...
#endif /* MBEDTLS_PSA_CRYPTO_C */
#if defined(MBEDTLS_PSA_CRYPTO_C)
#line 176 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_mbedtls_psa_get_random_length(int n)
{
...
static void test_mbedtls_psa_get_random_length_wrapper( void ** params )
{

    test_mbedtls_psa_get_random_length( ((mbedtls_test_argument_t *) params[0])->sint );
}
#endif /* MBEDTLS_PSA_CRYPTO_C */
#if defined(MBEDTLS_PSA_CRYPTO_C)
#if defined(MBEDTLS_ECDSA_C)
#line 192 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_random.function"
static void test_mbedtls_psa_get_random_ecdsa_sign(int curve)
{
...
static void test_mbedtls_psa_get_random_ecdsa_sign_wrapper( void ** params )
{

    test_mbedtls_psa_get_random_ecdsa_sign( ((mbedtls_test_argument_t *) params[0])->sint );
}
...
#if defined(MBEDTLS_ENTROPY_C) && !defined(MBEDTLS_PSA_INJECT_ENTROPY) && defined(MBEDTLS_CTR_DRBG_C)
...
#if defined(MBEDTLS_ENTROPY_C) && !defined(MBEDTLS_PSA_INJECT_ENTROPY) && defined(MBEDTLS_HMAC_DRBG_C)
...
static int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "./test_suite_random.datax";
