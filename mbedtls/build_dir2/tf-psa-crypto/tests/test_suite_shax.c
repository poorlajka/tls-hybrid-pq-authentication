 ...
 *      Test suite file     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function
 *      Test suite data     : /home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.data
 *
 */
...
#line 2 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
#include "mbedtls/sha1.h"
#include "mbedtls/sha256.h"
#include "mbedtls/sha512.h"
#include "mbedtls/sha3.h"
#if defined(MBEDTLS_SHA1_C)
#line 9 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_mbedtls_sha1(data_t *src_str, data_t *hash)
{
...
static void test_mbedtls_sha1_wrapper( void ** params )
{
...
#line 23 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha256_invalid_param(void)
{
...
static void test_sha256_invalid_param_wrapper( void ** params )
{
    (void)params;
...
#line 43 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha224(data_t *src_str, data_t *hash)
{
...
static void test_sha224_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
...
#if defined(MBEDTLS_SHA256_C)
#line 57 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_mbedtls_sha256(data_t *src_str, data_t *hash)
{
...
static void test_mbedtls_sha256_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
...
#line 71 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha512_invalid_param(void)
{
...
static void test_sha512_invalid_param_wrapper( void ** params )
{
    (void)params;
...
#line 91 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha384(data_t *src_str, data_t *hash)
{
...
static void test_sha384_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
...
#if defined(MBEDTLS_SHA512_C)
#line 105 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_mbedtls_sha512(data_t *src_str, data_t *hash)
{
...
static void test_mbedtls_sha512_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
...
#line 119 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha1_selftest(void)
{
...
static void test_sha1_selftest_wrapper( void ** params )
{
    (void)params;
...
#if defined(MBEDTLS_SHA224_C)
#if defined(MBEDTLS_SELF_TEST)
#line 126 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha224_selftest(void)
{
...
static void test_sha224_selftest_wrapper( void ** params )
{
    (void)params;

    test_sha224_selftest(  );
}
#endif /* MBEDTLS_SELF_TEST */
#endif /* MBEDTLS_SHA224_C */
#if defined(MBEDTLS_SHA256_C)
#if defined(MBEDTLS_SELF_TEST)
#line 133 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha256_selftest(void)
{
...
static void test_sha256_selftest_wrapper( void ** params )
{
    (void)params;
...
#if defined(MBEDTLS_SHA384_C)
#if defined(MBEDTLS_SELF_TEST)
#line 140 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha384_selftest(void)
{
...
static void test_sha384_selftest_wrapper( void ** params )
{
    (void)params;

    test_sha384_selftest(  );
}
#endif /* MBEDTLS_SELF_TEST */
#endif /* MBEDTLS_SHA384_C */
#if defined(MBEDTLS_SHA512_C)
#if defined(MBEDTLS_SELF_TEST)
#line 147 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha512_selftest(void)
{
...
static void test_sha512_selftest_wrapper( void ** params )
{
    (void)params;
...
#line 154 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_mbedtls_sha3(int family, data_t *in, data_t *hash)
{
...
static void test_mbedtls_sha3_wrapper( void ** params )
{
    ...
    test_mbedtls_sha3( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3 );
}
#endif /* MBEDTLS_SHA3_C */
#if defined(MBEDTLS_SHA3_C)
#line 170 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha3_invalid_param(void)
{
...
static void test_sha3_invalid_param_wrapper( void ** params )
{
    (void)params;

    test_sha3_invalid_param(  );
}
#endif /* MBEDTLS_SHA3_C */
#if defined(MBEDTLS_SHA3_C)
#line 193 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_mbedtls_sha3_multi(int family, data_t *in, data_t *hash)
{
    unsigned char *output = NULL;
    mbedtls_sha3_context ctx;
...
static void test_mbedtls_sha3_multi_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};
    data_t data3 = {(uint8_t *) params[3], ((mbedtls_test_argument_t *) params[4])->len};

    test_mbedtls_sha3_multi( ((mbedtls_test_argument_t *) params[0])->sint, &data1, &data3 );
}
#endif /* MBEDTLS_SHA3_C */
#if defined(MBEDTLS_SHA3_C)
#line 218 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha3_streaming(int type, data_t *input)
{
    mbedtls_sha3_context ctx;
...
static void test_sha3_streaming_wrapper( void ** params )
{
    data_t data1 = {(uint8_t *) params[1], ((mbedtls_test_argument_t *) params[2])->len};

    test_sha3_streaming( ((mbedtls_test_argument_t *) params[0])->sint, &data1 );
}
#endif /* MBEDTLS_SHA3_C */
#if defined(MBEDTLS_SHA3_C)
#line 268 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha3_reuse(data_t *input1, data_t *hash1,
...
static void test_sha3_reuse_wrapper( void ** params )
{
    data_t data0 = {(uint8_t *) params[0], ((mbedtls_test_argument_t *) params[1])->len};
    data_t data2 = {(uint8_t *) params[2], ((mbedtls_test_argument_t *) params[3])->len};
    ...
    test_sha3_reuse( &data0, &data2, &data4, &data6 );
}
#endif /* MBEDTLS_SHA3_C */
#if defined(MBEDTLS_SHA3_C)
#if defined(MBEDTLS_SELF_TEST)
#line 309 "/home/viktor/tls-hybrid-authentication/mbedtls/tf-psa-crypto/tests/suites/test_suite_shax.function"
static void test_sha3_selftest(void)
{
...
static void test_sha3_selftest_wrapper( void ** params )
{
    (void)params;
...
static int get_expression(int32_t exp_id, intmax_t *out_value)
{
    ...
    switch (exp_id) {
        ...
        case 0:
            {
                *out_value = MBEDTLS_SHA3_224;
            }
            break;
        case 1:
            {
                *out_value = MBEDTLS_SHA3_256;
            }
            break;
        case 2:
            {
                *out_value = MBEDTLS_SHA3_384;
            }
            break;
        case 3:
            {
                *out_value = MBEDTLS_SHA3_512;
            }
            break;
...
#if defined(MBEDTLS_SHA224_C) && defined(MBEDTLS_SELF_TEST)
    test_sha224_selftest_wrapper,
#else
    NULL,
#endif
/* Function Id: 9 */
...
#if defined(MBEDTLS_SHA384_C) && defined(MBEDTLS_SELF_TEST)
    test_sha384_selftest_wrapper,
#else
    NULL,
#endif
/* Function Id: 11 */
...
#if defined(MBEDTLS_SHA3_C)
    test_sha3_invalid_param_wrapper,
#else
    NULL,
#endif
/* Function Id: 14 */
...
#if defined(MBEDTLS_SHA3_C)
    test_mbedtls_sha3_multi_wrapper,
#else
    NULL,
#endif
/* Function Id: 15 */
...
#if defined(MBEDTLS_SHA3_C)
    test_sha3_reuse_wrapper,
#else
    NULL,
#endif
/* Function Id: 17 */

#if defined(MBEDTLS_SHA3_C) && defined(MBEDTLS_SELF_TEST)
    test_sha3_selftest_wrapper,
#else
    NULL,
#endif
